...
public class WireMillBlock extends IMTieredMachineBlock {

  public WireMillBlock(SpeedTier speedTier) {
    super(speedTier);
  }
  ...
  public TileEntity createTileEntity(BlockState state, IBlockReader world) {
    return IMTieredRegistryResolver.resolveTile(this.speedTier, IMTiles.WIREMILL).create();
  }
}
