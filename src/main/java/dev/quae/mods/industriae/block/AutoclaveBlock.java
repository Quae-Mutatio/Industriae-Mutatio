...
public class AutoclaveBlock extends IMTieredMachineBlock{

  public AutoclaveBlock(SpeedTier speedTier) {
    super(speedTier);
  }
  ...
  public TileEntity createTileEntity(BlockState state, IBlockReader world) {
    return IMTieredRegistryResolver.resolveTile(speedTier, IMTiles.AUTOCLAVE).create();
  }
}
